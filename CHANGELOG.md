...
| 日期 | 说明 | 详细文档 |
|------|------|----------|
| 2026-08-08 | **1.0.1 补丁**：Mac 打包下载、Key 持久化、取消下载、保存项目/正文 | [CHANGELOG-2026-08-08-patch.md](docs/CHANGELOG-2026-08-08-patch.md) |
...
- **保存**：项目与正文保存落盘更可靠。
- **发布**：`v1.0.1-2026-08-08`；Windows 产物目录 `E:/cursor-agent/deliverables/AuraCard-desktop-1.0.1/`。
