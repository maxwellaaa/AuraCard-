...
| 日期 | 说明 | 详细文档 |
|------|------|----------|
| 2026-08-10 | **1.0.3**：封面文字菜单、导出分辨率子菜单、智能 Popover、hint 统一、返回主页 | [CHANGELOG-2026-08-10.md](docs/CHANGELOG-2026-08-10.md) |
...
- **封面文字**：独立图层 + 浮动文字菜单（字号/颜色等）。
- **封面导出**：分辨率子菜单，按画幅给出像素尺寸提示。
- **智能 Popover**：浮动菜单自动避让顶栏/侧栏。
- **UI**：全局 `ui-hint` 统一；非首页「返回主页」。
